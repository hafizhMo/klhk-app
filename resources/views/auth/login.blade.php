        ...
        <form method="POST" action="{{ url('auth/login') }}">
            ...
            <div class="flex justify-between mb-6">
                ...
                <a href="{{ url('/auth/forgot-password') }}"
                    class="ml-2 text-sm underline hover:no-underline font-medium text-gray-900 hover:text-green-800">Forgot
                    password?</a>
            </div>
            ...
            <button type="submit"
                class="w-full text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Login</button>
        </form>
        <p>Doesn't have an account? <a href="{{ url('/auth/register') }}" class="underline">Register now!</a></p>
    </div>
@endsection
